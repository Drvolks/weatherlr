...
drvolks inc ("nous", "notre", "nos") exploite l'application mobile Weatherlr (ci-après désignée par le terme "Service").
...
drvolks inc peut communiquer vos Données à Caractère Personnel si elle estime de bonne foi que cela est nécessaire pour:

S'acquitter d'une obligation légale
Protéger et défendre les droits ou les biens de drvolks inc
...
Par courrier électronique: drvolks@gmail.com